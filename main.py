...
def download_chapter(scraper, base_url, chapter_num):
    ...
    try:
        ...
        create_cbz_file(manga_title, titles, chapterNumber)
...
def create_cbz_file(manga_title, titles, chapterNumber):
    """Create a CBZ file from the downloaded chapter images"""
